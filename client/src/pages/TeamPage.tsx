        ...
        <div className="container mx-auto px-4">
          ...
          >
            {teamMembers.map((member, index) => (
              ...
              >
                <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 h-full">
                  <div className="relative h-80 overflow-hidden">
                    ...
                    >
                      <h2 className="text-2xl font-bold text-white">
                        {member.name}
                        {member.nickname && <span className="text-sm ml-2 text-gray-300">({member.nickname})</span>}
                      </h2>
                      <p className="text-[#DAA520] font-medium">{member.role}</p>
                      <p className="text-white text-sm mt-1">{member.experience} of experience</p>
                    </motion.div>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-4">
                      <h3 className="text-sm font-semibold uppercase text-gray-500 mb-2">Expertise</h3>
                ...
                {activeCard === index && (
                  <>
                    <div 
                      className="absolute -inset-1 -z-10 bg-gradient-to-r from-[#DAA520]/20 to-black/20 rounded-xl blur-sm"
                      style={{
                        transform: `translateZ(-10px) rotateY(${mousePosition.x * 5}deg) rotateX(${-mousePosition.y * 5}deg)`,
                      }}
                    />
                    <div 
                      className="absolute -inset-3 -z-10 bg-gradient-to-r from-[#DAA520]/5 to-black/5 rounded-xl blur-lg"
                      style={{
                        transform: `translateZ(-20px) rotateY(${mousePosition.x * 5}deg) rotateX(${-mousePosition.y * 5}deg)`,
                      }}
                    />
                  </>
                )}
